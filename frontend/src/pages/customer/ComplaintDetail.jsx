...
export default function ComplaintDetail() {
  ...
  if (!c) return <div style={{ padding: 32, textAlign: 'center', color: isDark ? '#94A3B8' : '#9CA3AF' }}>Complaint not found.</div>;
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '24px 16px' }}>
      ...
      {/* Timeline */}
      <div style={{ background: cardBg, borderRadius: 16, padding: 24, boxShadow: '0 1px 8px rgba(0,0,0,0.06)', marginBottom: 16, border: `1px solid ${border}` }}>
        <h3 style={{ fontSize: 15, fontWeight: 700, color: textPrimary, marginBottom: 20 }}>Timeline</h3>
      ...
      {c.status === 'Resolved' && c.final_response_text && (
        <div style={{ background: cardBg, borderRadius: 16, padding: 24, boxShadow: '0 1px 8px rgba(0,0,0,0.06)', marginBottom: 16, borderLeft: '4px solid #0A1628', border: `1px solid ${border}` }}>
          <h3 style={{ fontSize: 15, fontWeight: 700, color: textPrimary, marginBottom: 12 }}>Bank's Response</h3>
      ...
      {c.status === 'Resolved' && !c.csat_rating && !submitted && (
        <div style={{ background: cardBg, borderRadius: 16, padding: 24, boxShadow: '0 1px 8px rgba(0,0,0,0.06)', marginBottom: 16, border: `1px solid ${border}` }}>
          <h3 style={{ fontSize: 15, fontWeight: 700, color: textPrimary, marginBottom: 12 }}>How was your experience?</h3>
